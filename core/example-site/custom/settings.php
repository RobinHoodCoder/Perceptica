...
$bigtree["config"]["trailing_slash_behavior"] = "remove"; // Options are none, append, remove

// CSS settings
$bigtree["config"]["css"]["prefix"] = false; // Flag for BigTree CSS3 parsing - automatic vendor prefixing for standard CSS3
$bigtree["config"]["css"]["minify"] = true; // Flag for CSS minification
...
$bigtree["config"]["image_force_jpeg"] = true; // Set to true to make images uploaded as PNG save as JPG
...
$bigtree["config"]["settings_key"] = "5b1bd5d05db538.64551844";
